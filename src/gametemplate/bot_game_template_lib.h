...
public:
    ...
    int getParticleEffectTemplateLibSize() const
    {
        return m_particleEffectTemplateLib.getLibSize();
    }

    const ParticleEffectTemplate* getParticleEffectTemplate(int idx) const
    {
        return m_particleEffectTemplateLib.getObject(idx);
    }

    const ParticleEffectTemplate* getParticleEffectTemplate(const std::string& name) const
    {
        return m_particleEffectTemplateLib.getObject(name.c_str());
    }
...
private:
    ...
    NamedLib<ParticleEffectTemplate> m_particleEffectTemplateLib;
