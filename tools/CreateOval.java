...
public static void createOval(int width, int height, Color color, String file)
{
...
public static void main(String[] args) {
    if(args.length != 4) {
        System.err.println("java CreateOval width height color outputFile");
        System.exit(1);
    }
    ...
    createOval(width, height, color, args[3]);
}
